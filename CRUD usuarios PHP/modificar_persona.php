        ...
        <div class="col-md-4 p-3 m-auto"> <!-- Columna para el formulario -->
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" aria-describedby="emailHelp" name="nombres" value="<?= $datos->nombres ?>">
                </div>
                ...
                <a href="index.php" type="submit" class="btn btn-danger"  >Volver</a>
