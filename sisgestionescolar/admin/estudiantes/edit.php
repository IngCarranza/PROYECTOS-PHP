...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1><b>Modificación de los datos del estudiante: <?=$apellidos." ".$nombres?></b></h1>
            </div>
            <br>
            ...
            <form action="<?=APP_URL;?>/app/controllers/estudiantes/update.php" method="post">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-outline card-success">
                            <div class="card-header">
                                <h3 class="card-title">Editar los datos del padre del estudiante</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="email">Celular de la referencia</label>
