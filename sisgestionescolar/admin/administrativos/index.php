...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Listado de los administrativos</h1>
            </div>
            <br>
            <div class="row">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="create.php" class="btn btn-primary"><i class="bi bi-plus-square"></i> Crear un nuevo administrativo</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <th><center>Carnet de identidad</center></th>
                                ...
                                foreach ($administrativos as $administrativo) {
                                    ...
                                    ?>
                                    <tr>
                                        <td style=""><?php echo $contador_administrativos; ?></td>
                                        <td><?php echo $administrativo['nombres'] . " " . $administrativo['apellidos']; ?></td>
                                        <td><?php echo $administrativo['nombre_rol']; ?></td>
                                        <td><?php echo $administrativo['ci']; ?></td>
                                        <td style="text-align: center"><?php echo $administrativo['fecha_nacimiento']; ?></td>
                                        <td><?php echo $administrativo['email']; ?></td>
                                        <td>
                                            <?php
